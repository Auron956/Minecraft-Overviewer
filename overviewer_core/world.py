...
class RegionSet(object):
    ...
    def __init__(self, regiondir, rel):
        ...
        for i in range(len(colors)):
            # For beds: bits 1-2 indicate facing, bit 3 indicates whether head or foot of bed
            self._blockmap['minecraft:%s_bed'                % colors[i]] = (26, i << 3)
            ...
            # Shulker box: Bits 1-3 indicate facing
            self._blockmap['minecraft:%s_shulker_box'        % colors[i]] = (219, i << 3)
