...
class RegionSet(object):
    ...
    def __init__(self, regiondir, rel):
        ...
        self._blockmap = {
            ...
            'minecraft:cornflower': (38, 10),
            'minecraft:wither_rose': (38, 11),
        ...
        for i in range(len(colors)):
            self._blockmap['minecraft:%s_bed'                % colors[i]] = (26, i << 3) # Bits 1-2 indicate facing, bit 3 indicates whether foot of bed or not
    ...
    def _get_block(self, palette_entry):
        ...
        # handle double slabs 
            if palette_entry['Properties']['type'] == 'top':
                ...
                if key in wood_slabs:
                    ...
                    if key == 'minecraft:prismarine_slab':
                     ...
                     'minecraft:trapped_chest', 'minecraft:furnace', 'minecraft:blast_furnace']:
            facing = palette_entry['Properties']['facing']
            ...
            elif key in ['minecraft:furnace', 'minecraft:blast_furnace']:
            ...
            facing = palette_entry['Properties']['facing']
            data = {'south': 0, 'west': 1, 'north': 2, 'east': 3}[facing]
        elif key in ['minecraft:vine', 'minecraft:brown_mushroom_block', 'minecraft:red_mushroom_block',
